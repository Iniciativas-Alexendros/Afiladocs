...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/revisiones`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/suscripciones`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    // REDIRIGIDOS 301: /blog → /contacto, /sobre-mi → /contacto, /informes-juridicos → /, /legaltech-ia → /
  ]
}
