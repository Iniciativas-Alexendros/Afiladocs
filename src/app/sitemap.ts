...
// URL base dinámica — misma lógica que layout.tsx y robots.ts.
// Mientras no haya dominio propio, el sitemap apunta al subdominio .vercel.app.
// Cuando se adquiera el dominio: definir NEXT_PUBLIC_SITE_URL en Vercel Dashboard.
const BASE_URL =
